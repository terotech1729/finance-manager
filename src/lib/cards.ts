...
export const CARDS: readonly Card[] = [
  ...
  },
  {
    ...
    statementDay: 21,
    cycleEnd: "2026-10-21",
    notes: "Fee anniversary ~21 Oct (waiver year = day after fee → next fee). ONLINE voucher milestones (₹1L/₹2L Amazon) track a separate year — statement reset ~22 May 2026. Tax/rent usually excluded from fee waiver; vouchers need online spend.",
  },
  {
    id: "amazon_pay_icici",
...
export const ANNUAL_MILESTONES: readonly AnnualMilestone[] = [
  ...
  { cardId: "sbi_simplyclick", threshold: 100000, reward: "₹2K Amazon voucher (online spends)", rewardValueInr: 2000, hit: false, notes: "Separate from fee waiver — use statement ONLINE SPENDS SUMMARY" },
  { cardId: "sbi_simplyclick", threshold: 200000, reward: "Additional ₹2K Amazon voucher (online)", rewardValueInr: 2000, hit: false },
