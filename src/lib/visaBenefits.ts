...
export const VISA_TIER_GUIDES: VisaTierGuide[] = [
  {
    ...
    perks: [
      ...
      },
      {
        id: "inf-itc",
        title: "ITC Hotels",
        blurb: "Comp night / % off when the offer is live",
        summary: "Preferential ITC stays (complimentary night or second-night deals on participating properties).",
        howToClaim: "Book via Visa × ITC / ITC site with Infinite BIN; pay Infinite.",
        eligibility: "India-issued Visa Infinite; offer windows rotate.",
        valueHint: "1 free night",
        link: "https://www.visa.co.in/",
      },
      {
        id: "inf-avis",
        title: "Avis rentals",
        blurb: "Preferred rates & upgrades",
        summary: "Preferred rates / upgrades on Avis for Infinite holders.",
      ...
      },
      {
        id: "inf-times-prime",
        title: "Times Prime",
        blurb: "Spotify, Uber One, OTT packs",
        summary: "Often bundled with Infinite (Live+ advertises 12-mo Times Prime).",
        howToClaim: "Activate via timesprime.com Visa offer (₹1 auth).",
        valueHint: "₹1k+ if used",
