...
export function Toaster() {
  ...
  return (
    <div className="fixed z-50 flex flex-col gap-2 pointer-events-none left-3 right-3 sm:left-auto sm:right-4 sm:max-w-sm bottom-[max(1rem,env(safe-area-inset-bottom))]">
      {items.map((t) => (
        <div
          key={t.id}
